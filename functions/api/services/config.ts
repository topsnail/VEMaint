...
const DEFAULT_CONFIG: SystemConfig = {
  ...
  dropdowns: {
    ...
    vehicleStatus: ["正常", "维修中", "停用", "报废"],
    maintenanceType: ["日常保养", "故障维修", "事故维修", "定期检修"],
    resultStatus: ["已修复", "临时处理", "待复查"],
    maintenanceTargetType: ["车辆", "设备", "其他"],
    userRole: ["管理员", "维保员", "只读用户"],
    ...
    vehicleDueLevel: ["已逾期", "7天内", "30天内", "全部临期"],
    vehicleIncompleteOnly: ["仅看不完整"],
    alertActionStatus: ["待处理", "处理中", "已处理"],
    pageSize: ["10 / 页", "20 / 页", "50 / 页"],
    itemDesc: ["保养", "维修", "其他"],
    userRoleTemplateSuffix: ["（全权限）", "（可录入/编辑维保与周期）", "（仅查看）"],
  },
  ownerDirectory: [
